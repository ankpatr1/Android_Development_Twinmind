    ...
    >
      ...
      <Collapsible title="Animations">
        <ThemedText>
          ...
          <ThemedText type="defaultSemiBold">react-native-reanimated</ThemedText> for animations.
        </ThemedText>
        {Platform.select({
          ios: (
            <ThemedText key="ios-parallax-note">
              The <ThemedText type="defaultSemiBold">ParallaxScrollView</ThemedText> component provides a parallax effect for the header image.
            </ThemedText>
          ),
        })}
      </Collapsible>
